...
Shader "WaterFlow"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 uv_TexCoord9 = v.texcoord.xy * float2( 2,0.2 ) + float2( 0,0.2 );
			float2 panner1 = ( _Time.y * float2( 0,-0.05 ) + uv_TexCoord9);
			...
			float mulTime20 = _Time.y * 1.5;
			float2 panner17 = ( mulTime20 * float2( 0,-0.1 ) + uv_TexCoord9);
		...
		{
			float2 uv_TexCoord9 = i.uv_texcoord * float2( 2,0.2 ) + float2( 0,0.2 );
			float2 panner1 = ( _Time.y * float2( 0,-0.05 ) + uv_TexCoord9);
			float simplePerlin2D4 = snoise( panner1*7.0 );
			simplePerlin2D4 = simplePerlin2D4*0.5 + 0.5;
			float simplePerlin2D8 = snoise( panner1*15.0 );
...
/*ASEBEGIN
Version=18000
33;3;1218;983;575.4924;337.3349;1;True;False
...
Node;AmplifyShaderEditor.Vector2Node;19;-1303.92,640.478;Inherit;False;Constant;_Vector1;Vector 1;0;0;Create;True;0;0;False;0;0,-0.1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.ColorNode;23;-255.5264,-290.2238;Inherit;False;Property;_Water_Tip;Water_Tip;1;0;Create;True;0;0;False;0;0.5301709,0.6981132,0.6330701,0;0.5301709,0.6981132,0.6330701,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;22;-255.5264,-510.2238;Inherit;False;Property;_Base_Water;Base_Water;0;0;Create;True;0;0;False;0;0.2754015,0.3301887,0.2227216,0;0.2754015,0.3301887,0.2227216,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=FAA22C04E9CD4D8E5AB51C7F9DAC79EA6B7AB67A