...
Shader "WaterPool_Flow"
{
	Properties
	{
		_Base_Water("Base_Water", Color) = (0.7329566,0.8584906,0.8074924,1)
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float layeredBlend67 = ( lerp( (0.0 + (temp_output_79_0 - 0.0) * (0.02 - 0.0) / (1.0 - 0.0)),(0.0 + (temp_output_59_0 - 0.0) * (0.06 - 0.0) / (1.0 - 0.0)) , layeredBlendVar67 ) );
...
/*ASEBEGIN
Version=18000
0;1;1920;1020;1603.103;-423.1951;1;True;True
...
Node;AmplifyShaderEditor.SimpleTimeNode;95;-872.3585,1169.097;Inherit;False;1;0;FLOAT;0.2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;62;-856.4421,984.0052;Inherit;False;1;0;FLOAT;0.1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;63;-854.4973,727.1727;Inherit;False;1;0;FLOAT;0.05;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;64;505.5673,-59.61413;Inherit;False;Property;_Base_Water;Base_Water;0;0;Create;True;0;0;False;0;0.7329566,0.8584906,0.8074924,1;0.2754015,0.3301887,0.2227216,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LayeredBlendNode;65;909.2336,130.3949;Inherit;True;6;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.TFHCRemapNode;58;1057.303,556.1572;Inherit;True;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;0.06;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;81;1126.143,1521.084;Inherit;True;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;0.02;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;86;1183.413,1175.4;Inherit;True;Property;_TextureSample0;Texture Sample 0;4;0;Create;True;0;0;False;0;-1;3d74b66c00fbb7245966a6be8c5ebd2f;3d74b66c00fbb7245966a6be8c5ebd2f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LayeredBlendNode;67;1679.454,1008.488;Inherit;True;6;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=331C0CD5E3DB0BED88F342F4792B34C771C64EAB